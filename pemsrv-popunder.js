(function () {
  ...
  window.document.querySelectorAll ||
    (document.querySelectorAll = document.body.querySelectorAll = Object.querySelectorAll = function (e, o, t, i, n) {
      var r = document,
  ...
  var popMagic = {
    ...
    isAdsDomainLicensed: function () {
      for (var e = this.config.ads_host, o = this.remoteLicensedDomains.concat([".local", "localhost", "127.0.0.1"]), t = 0; t < o.length; t++) {
        var i = o[t];
        if ("string" == typeof i)
          if ("." === i.charAt(0)) {
            var n = i,
    ...
    init: function (e) {
      if (void 0 !== e.idzone && e.idzone) {
        ...
        if (void 0 !== this.config.idzone && "" !== this.config.idzone) {
          !0 !== this.config.only_inline && this.isAdsDomainLicensed() && this.loadHosted();
          var i = this;
    ...
    preparePop: function () {
      if ("object" != typeof exoJsPop101 || !Object.prototype.hasOwnProperty.call(exoJsPop101, "add")) {
        ...
        if (
          ...
          popMagic.config.capping_enabled || (document.cookie = popMagic.cookie_name + "=;expires=Thu, 01 Jan 1970 00:00:01 GMT; path=/"),
    ...
    getPopMethod: function (e) {
      return popMagic.config.popup_force || (popMagic.config.popup_fallback && e.isChrome && e.version >= 68 && !e.isMobile)
    ...
    checkTCFConsent: function (e) {
      if (this.config.tcf_enabled && "function" == typeof window.__tcfapi) {
        ...
        window.__tcfapi("addEventListener", 2, function (t, i) {
          if (!i) return;
          o.tcfData = t;
          if ("tcloaded" !== t.eventStatus && "useractioncomplete" !== t.eventStatus) return;
    ...
    buildUrl: function () {
      var e,
        o = "https:" !== document.location.protocol && "http:" !== document.location.protocol ? "https:" : document.location.protocol,
        ...
        if ("2" != popMagic.config.trigger_method || "" == popMagic.config.trigger_class)
          if ("4" != popMagic.config.trigger_method || "" == popMagic.config.trigger_class)
            if ("5" != popMagic.config.trigger_method || "" == popMagic.config.trigger_class) popMagic.addEventToElement(document, e, o);
              ...
              var i = "a" + popMagic.getTriggerClasses().map(function (e) {
                return ":not(" + e + ")";
              }).join("");
    ...
    executeOnRedirect: function () {
      try {
        popMagic.config.capping_enabled || "function" != typeof popMagic.config.on_redirect || popMagic.config.on_redirect();
      } catch (e) {
    ...
    methods: {
      ...
      popup: function (e) {
        ...
        popMagic.setAsOpened(e),
          setTimeout(function () {
            (n.location.href = popMagic.url), popMagic.executeOnRedirect();
          }, 200),
          void 0 !== e.preventDefault && (e.preventDefault(), e.stopPropagation());
      },
    },
