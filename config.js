...
window.SITE_CONFIG = {
  ...
  /** ExoClick — popunder 1 : déclenché au clic sur « Voir la galerie » (pas sur +18, pour éviter la redirection pleine page) */
  exoPopunder1Idzone: 5880410,
  /** ExoClick — 2ᵉ zone popunder pour page2.html (crée une nouvelle zone dans le dashboard et colle l’ID ici) */
  exoPopunder2Idzone: 5880410,
  ...
  // ═══ Preview 1 : 4 images floutées — déblocage via stripeUrl (bouton + clic sur chaque carte)
  preview1Title: "Photos premium",
  preview1Hint: "Aperçu flouté — débloquez avec Stripe pour voir en HD.",
  preview1Images: [
    { file: "a.png.png", title: "Photo 1" },
    { file: "bpng.jpg", title: "Photo 2" },
    { file: "se.png", title: "Photo 3" },
    { file: "f.png", title: "Photo 4" },
  ],

  // ═══ Preview 2 : 4 vidéos floutées / verrouillées — même lien Stripe
  preview2Title: "Vidéos premium",
  preview2Hint: "Vidéos verrouillées — payez sur Stripe pour débloquer l’accès complet.",
  preview2Videos: [
    { url: "https://www.w3schools.com/html/mov_bbb.mp4", title: "Vidéo 1" },
    { url: "https://interactive-examples.mdn.mozilla.net/media/cc0-videos/flower.mp4", title: "Vidéo 2" },
    { url: "https://www.w3schools.com/html/mov_bbb.mp4", title: "Vidéo 3" },
    { url: "https://interactive-examples.mdn.mozilla.net/media/cc0-videos/flower.mp4", title: "Vidéo 4" },
  ],
};
